    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        AspUser = c.String(nullable: false),
                    })
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.MyUser_UserId, t.School_SchoolId })
                .ForeignKey("dbo.MyUsers", t => t.MyUser_UserId, cascadeDelete: true)
                .ForeignKey("dbo.Schools", t => t.School_SchoolId, cascadeDelete: true)
                .Index(t => t.MyUser_UserId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.MyUserSchools", "School_SchoolId", "dbo.Schools");
            DropForeignKey("dbo.MyUserSchools", "MyUser_UserId", "dbo.MyUsers");
            DropForeignKey("dbo.Schools", "SchoolId", "dbo.Addresses");
            DropIndex("dbo.MyUserSchools", new[] { "School_SchoolId" });
            DropIndex("dbo.MyUserSchools", new[] { "MyUser_UserId" });
